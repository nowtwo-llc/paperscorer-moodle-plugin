...
$string['grade-item-not-manual'] = 'Only manual grade items can be edited.';
$string['grade-item-not-writable'] = 'Grades cannot be written to a course or category total.';
$string['no-secure-random'] = 'No cryptographically secure random source is available on this server.';
$string['no-such-user'] = 'No such user.';
$string['no-such-quiz'] = 'No such quiz in this course.';
$string['no-quiz-permission'] = 'User {$a->userid} does not have permission to read the questions for quiz {$a->quizid}. Exporting a quiz requires the mod/quiz:manage capability.';
